...
export default class GoalPanel {
  ...
  /**
   * Change the goal display settings (gets triggered if the user changes their settings).
   */
  ...
  /**
   * Create the goal panel if it doesn't exist and then handle a proofview notification.
   */
  ...
  private _handleProofViewResponseOrNotification(pv: ProofViewNotification) {
    console.time("GoalPanel._handleProofViewResponseOrNotification");
    console.log(pv);
    this._panel.webview.postMessage({
      command: "renderProofView",
      proofView: pv,
    });
    console.timeEnd("GoalPanel._handleProofViewResponseOrNotification");
  }
